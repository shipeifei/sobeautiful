...
gulp.task('concat', function() {
  gulp.src(['./dev/modules/header.js','./dev/modules/string-extend.js','./dev/modules/array-extend.js','./dev/modules/data-type.js', './dev/modules/data-set.js',, './dev/modules/query-dom.js']) //要合并的文件
